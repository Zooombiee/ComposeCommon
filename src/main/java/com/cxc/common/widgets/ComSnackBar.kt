...
val moeSnackBarQueue = mutableStateListOf<ComSnackBarData>()
...
data class ComSnackBarData constructor(
    val message: MutableState<String>,
    val modifier: Modifier = Modifier.padding(8.dp, 8.dp, 8.dp, 0.dp),
    val duration: Long = ComSnackBar.SHORT,
    val onCancel: ((ComSnackBarData) -> Unit)? = null,
    val onConfirm: ((ComSnackBarData) -> Unit)? = null,
    val cancelLabel: String = stringRes(R.string.common_cancel),
    val confirmLabel: String = stringRes(R.string.common_confirm),
    val onDismiss: ((ComSnackBarData) -> Unit)? = null,
    ...
    val content: @Composable ((ComSnackBarData) -> Unit)? = null,
)
...
fun ComSnackBar(
    ...
    Column(
        ...
        val state =  SettingPreferences.DarkMode.Light
...
fun ComSnackBarData.dismiss() = apply {
    mainMoeScope.launch {
...
fun ComSnackBarData.show() = apply {
    mainMoeScope.launch {
